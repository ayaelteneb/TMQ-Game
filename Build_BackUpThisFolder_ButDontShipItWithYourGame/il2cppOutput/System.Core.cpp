...
IL_001d:
	{
		Exception_t* L_5;
		L_5 = Error_ExtensionNodeMustOverrideProperty_mA12643E892AFF26852C56E3A90AA18A118004E81(((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteral4767E340F13B362444D8AE5CE8AE0CF983961DE1)), NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Expression_t70AA908ECBD33E94249BF235E4EBB0F831AD8785* Expression_Reduce_mC29568DCEEDB09AF835AA0339448DE3502333D01 (Expression_t70AA908ECBD33E94249BF235E4EBB0F831AD8785* __this, const RuntimeMethod* method) 
{
	...
	{
		Exception_t* L_1;
		L_1 = Error_ReducibleMustOverrideReduce_mAE953AD8ADD06F437B185711006477EE2A301227(NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Expression_t70AA908ECBD33E94249BF235E4EBB0F831AD8785* Expression_VisitChildren_m06C46AA86F547C59012080E420831412F0FEA9AC (Expression_t70AA908ECBD33E94249BF235E4EBB0F831AD8785* __this, ExpressionVisitor_tD26583FF464068F23017BC372C81133A62C5A590* ___visitor0, const RuntimeMethod* method) 
{
	...
	{
		Exception_t* L_1;
		L_1 = Error_MustBeReducible_m922FE30AD92EE0EBD91A8AFF6CE502A7F7B7D17B(NULL);
...
IL_001c:
	{
		Exception_t* L_5;
		L_5 = Error_MustReduceToDifferent_m3E5B1637A6C2827AA29495B962E28F06632F755A(NULL);
...
IL_0022:
	{
		...
		bool L_9;
		L_9 = TypeUtils_AreReferenceAssignable_m1A983B98D83D1388BD86E1F6CC5A340D28B73236(L_6, L_8, NULL);
		if (L_9)
		{
			goto IL_003b;
		}
	...
	{
		Exception_t* L_10;
		L_10 = Error_ReducedNotCompatible_mE8F7E6585B3E0B5DAF399DF42E2315F05ED79CFD(NULL);
...
IL_0024:
		...
		{// begin try (depth: 1)
			...
			DebugViewWriter_WriteTo_mC646A3BF92EEFB28B29C93F9495D384BF4874906(__this, L_4, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool TypeUtils_AreEquivalent_m8151407409689E4CFBFE4D92D2A1DB7992A9A52C (Type_t* ___t10, Type_t* ___t21, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_2);
		bool L_4;
		L_4 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(112 /* System.Boolean System.Type::IsEquivalentTo(System.Type) */, L_2, L_3);
		return L_4;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TypeUtils__cctor_m3C35AF4AAD759A0B845E1D43C1B06012CB22BC7B (const RuntimeMethod* method) 
{
	...
	}
	{
		...
		L_2 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(110 /* System.Type[] System.Type::GetInterfaces() */, L_1);
